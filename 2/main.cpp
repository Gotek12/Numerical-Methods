...
void choleskyTridiagonal()
{
    ...
    gsl_vector *upperLowerD = gsl_vector_alloc(N); //gorna
    ...
    //metoda rozwiązująca macierze 3-diagonalne symetryczne i cykliczne za pomocą faktoryzacji Choleskiego
    gsl_linalg_solve_symm_cyc_tridiag(mainD, upperLowerD, spare, result);
    ...
    //https://www.wolframalpha.com/input/?i=%7B(4,1,0,0,0,0,1),(1,4,1,0,0,0,0),(0,+1,4,1,0,0,0),(0,+0,+1,4,1,0,0),(0,+0,+0,+1,4,1,0),+(0,+0,+0,+0,+1,4,1),+(1,+0,+0,+0,+0,+1,4)%7D*(a,b,c,d,e,f,g)%3D(1,2,3,4,5,6,7)
