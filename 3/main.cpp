...
void licz(){
	...
	//funkcjonalność pozwalająca zmienić zwykłą tablice na macierz NxN
	gsl_matrix_view tmpM = gsl_matrix_view_array(mTab, N, N);
	//poźniej należy umieścić ją w odpowiednim miejscu
	gsl_matrix_memcpy(symM, &tmpM.matrix);
		
	//alokacja pamieci dla wektorow b1, b2, b3 i b4
	...
	//alokacja pamieci na wyniki mnożenia macierzy przez wektor
